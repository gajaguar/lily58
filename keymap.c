...
[_NUMBERS] = LAYOUT( \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_NUM,  XXXXXXX, XXXXXXX, XXXXXXX, KC_PSLS, KC_BSPC, \
...
[_GAME] = LAYOUT( \
  ...
  KC_G,    KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,                      XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, \
...
[_LOWER] = LAYOUT( \
  ...
  XXXXXXX, KC_SLSH, KC_ASTR, KC_MINS, KC_PLUS, XXXXXXX, _______, _______, XXXXXXX, TD_LBRC, TD_RBRC, XXXXXXX, XXXXXXX, _______, \
...
[_EXTRA] = LAYOUT( \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   RM_NEXT, RM_HUEU, RM_SATU, RM_VALU, XXXXXXX, NORMAL,  \
